        ...
        <div className="flex-1 grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8">
          ...
          <div className="lg:col-span-8 flex flex-col gap-4 sm:gap-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-4">
              {[2.5, 10, 50, 100].map((amount) => (
                <button
                  key={amount}
                  onClick={() => placeBid(room.currentBid + amount)}
                  disabled={hasReachedLimit || (currentPlayer && currentPlayer.budget < room.currentBid + amount) || room.highestBidder === socket.id}
              ...
              {isLastPick && (
                <button
                  ...
                  disabled={hasReachedLimit || !currentPlayer || currentPlayer.budget <= room.currentBid || room.highestBidder === socket.id}
